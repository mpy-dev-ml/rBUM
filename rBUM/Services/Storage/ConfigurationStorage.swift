...
final class ConfigurationStorage: ConfigurationStorageProtocol, StorageServiceProtocol {
    ...
    init(
        ...
        logger.debug(
            "Configuration storage initialized at \(configURL.path)",
            file: #file,
            function: #function,
            line: #line
        )
    ...
    func load() throws -> Configuration {
        ...
        do {
            ...
            logger.error(
                "Failed to load configuration: \(error.localizedDescription)",
                file: #file,
                function: #function,
                line: #line
            )
    ...
    func reset() throws {
        ...
        do {
            ...
            logger.error(
                "Failed to reset configuration: \(error.localizedDescription)",
                file: #file,
                function: #function,
                line: #line
            )
