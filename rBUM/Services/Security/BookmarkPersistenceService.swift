//
//  BookmarkPersistenceService.swift
//  rBUM
//
...
public final class BookmarkPersistenceService: BaseSandboxedService, BookmarkPersistenceProtocol, HealthCheckable {
    ...
    public init(
        ...
        operationQueue.name = "dev.mpy.rBUM.bookmarkPersistenceQueue"
...
public enum BookmarkError: LocalizedError {
    ...
    public var errorDescription: String? {
        ...
        case .accessDenied:
            "Access denied to bookmarked resource"
        case .invalidBookmark:
            "Invalid or corrupted bookmark"
        }
    }
}
