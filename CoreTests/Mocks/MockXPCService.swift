...
extension MockXPCService: ResticXPCServiceProtocol {
    ...
    public func initializeRepository(at _: URL, username _: String, password _: String) async throws {
    ...
    public func backup(from _: URL, to _: URL, username _: String, password _: String) async throws {
        guard isConnected else {
            throw SecurityError.xpcConnectionFailed("Not connected")
        }
    ...
    public func listSnapshots(username _: String, password _: String) async throws -> [String] {
        guard isConnected else {
            throw SecurityError.xpcConnectionFailed("Not connected")
        }
    ...
    public func restore(from _: URL, to _: URL, username _: String, password _: String) async throws {
        guard isConnected else {
            throw SecurityError.xpcConnectionFailed("Not connected")
        }
