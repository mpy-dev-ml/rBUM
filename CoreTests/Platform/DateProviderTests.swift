...
final class DateProviderTests: XCTestCase {
    ...
    override func setUp() async throws {
        ...
        fixedDate = Date(timeIntervalSince1970: 1706976000) // 2024-02-03 17:00:00 UTC
    ...
    func testDateComparison() throws {
        let earlier = Date(timeIntervalSince1970: 1706975900) // 100 seconds earlier
        let later = Date(timeIntervalSince1970: 1706976100)   // 100 seconds later
    ...
    func testDateDifference() throws {
        let earlier = Date(timeIntervalSince1970: 1706975400) // 600 seconds earlier
        let later = Date(timeIntervalSince1970: 1706976600)   // 600 seconds later
