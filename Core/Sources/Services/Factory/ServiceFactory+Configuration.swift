...
public extension ServiceFactory {
    ...
    public struct Configuration {
        ...
        /// In non-DEBUG builds, development features and debug logging are disabled, while metrics collection and circuit breakers are enabled.
        /// 
    ...
    public let delegate: ServiceDelegate
    ...
    public init(configuration: Configuration, delegate: ServiceDelegate) {
        self.configuration = configuration
        self.delegate = delegate
        self.logger = LoggerFactory.createLogger(category: .serviceFactory)
    }
}
