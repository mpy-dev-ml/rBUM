...
public protocol ResticCommandServiceProtocol {
    ...
    func restoreSnapshot(_ snapshot: Snapshot, from repository: Repository, credentials: RepositoryCredentials, to path: URL) async throws
    ...
    func deleteSnapshot(_ snapshot: Snapshot, from repository: Repository, credentials: RepositoryCredentials) async throws
}
